...
class RawatJalanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $cacheKey = 'rawatjalan_index_' . md5(serialize($request->all()));
        ...
        $result = Cache::remember($cacheKey, 300, function () use ($request) {
            ...
            $rawatJalan = $query->orderBy('reg_periksa.tgl_registrasi', 'desc')
                ...
                ->simplePaginate(25)
                ->withQueryString();
            return compact('rawatJalan', 'total');
        });
        return view('rawatjalan.index', $result);
    }
    ...
    public function detail($no_rawat)
    {
        ...
        return view('rawatjalan.detail', compact('data', 'kategori', 'berkas'));
    }
