                    ...
                    <div class="card shadow-sm rounded-4 h-100">
                        ...
                        <div class="card-body">
                            <form action="{{ route('rawatinap.upload_resume', $data->no_rawat) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="kode" class="form-label fw-semibold">Kategori Berkas</label>
                                ...
                                <div class="mb-4">
                                    <label for="file" class="form-label fw-semibold">Pilih Berkas (.pdf / .jpg)</label>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content rounded-4">
                        <div class="modal-header bg-warning text-white">
                            ...
                            <button type="button" class="btn-close btn-close-white mb-1" data-bs-dismiss="modal"
                        ...
                        <form action="{{ route('rawatinap.update_status', $data->no_rawat) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="status" class="form-label fw-bold">Status Klaim <span
                                    ...
                                    @if (isset($vedikaData) && $vedikaData->status)
                                        <div class="form-text">Status saat ini: <strong>{{ $vedikaData->status }}</strong>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Berikan catatan detail mengenai status klaim dan umpan balik
                                        yang diperlukan</div>
                                </div>
                                ...
                                @if (isset($vedikaData) && ($vedikaData->status || $vedikaData->catatan))
                                    <div class="alert alert-info">
                                        ...
                                        @if ($vedikaData->catatan)
                                            <p class="mb-0"><strong>Catatan Sebelumnya:</strong>
                                                {{ $vedikaData->catatan }}</p>
                                        @endif
                                    </div>
                                @else
                                    <div class="alert alert-warning">
                                        <strong>Perhatian:</strong> Belum ada data status klaim untuk rawat inap ini. Status
                                        dan catatan akan dibuat baru.
                                    </div>
                                @endif
                            </div>
