...
@section('title', 'Daftar Resume Rawat Inap')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('rawatinap.detail', $no_rawat) }}">Detail Rawat Inap</a></li>
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <span class="badge badge-success">{{ $berkas->count() }} File</span>
                            </div>
                        </div>
