<div class="col-md-12">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div id="preview-wrapper" class="ml-md-4 mt-4 mt-md-0 d-none" style="width: 800px;">
                        ...
                        <div id="preview-container" class="border rounded p-2 bg-white">
                            <iframe id="preview-pdf" class="w-100" style="height: 500px; display: none;" frameborder="0"></iframe>
                            <img id="preview-image" class="img-fluid d-block mx-auto" style="max-height: 500px; display: none;" />
                        </div>
                    </div>
                </div>
            </form>
    ...
    <button type="button" class="btn btn-sm btn-outline-primary"
        ...
        data-file="{{ asset('storage/' . $file->lokasi_file) }}"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center bg-light">
                            <iframe id="modal-pdf" class="w-100" style="height: 600px; display: none;" frameborder="0"></iframe>
                            <img id="modal-image" class="img-fluid" style="max-height: 600px; display: none;" />
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $('#modalPreview').on('show.bs.modal', function (event) {
        ...
        console.log('Previewing:', fileUrl, 'Type:', fileType); // 👈 debug
