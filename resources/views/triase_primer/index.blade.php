...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <form action="{{ route('triase-primer.index') }}" method="GET" class="form-inline float-right">
            ...
            <h3 class="card-title mt-2">Daftar Pasien Triase Primer</h3>
        </div>
                    ...
                    <div class="modal fade" id="editModal{{ $loop->index }}" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('triase-primer.update', $item->no_rawat) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Triase Primer</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="keluhan_utama" class="form-control form-control-sm"
                                                    rows="2">{{ $item->keluhan_utama }}</textarea>
                                            </div>

                                            <div class="col-md-6">
                                                <label>Kebutuhan Khusus</label>
                                                <textarea name="kebutuhan_khusus" class="form-control form-control-sm"
                                                    rows="2">{{ $item->kebutuhan_khusus }}</textarea>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <select name="plan" class="form-control form-control-sm" required>
                                                    ...
                                                    <option value="Ruang Kritis" {{ $item->plan == 'Ruang Kritis' ?
                                                        'selected' : '' }}>
                                                        Ruang Kritis
                                                    </option>
                                                    <option value="Ruang Resusitasi" {{ $item->plan == 'Ruang
                                                        Resusitasi' ? 'selected' : '' }}>
                                                        Ruang Resusitasi
                                                    </option>
                                                </select>
